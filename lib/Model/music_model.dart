...
class MusicGenre {
  ...
  MusicGenreNameEnum musicGenreName;
  MusicGenreNameEnum musicGenreNameExtended;
  MusicGenreNameEnum musicGenreVanity;
  ...
  factory MusicGenre.fromJson(Map<String, dynamic> json) => MusicGenre(
        ...
        musicGenreName: musicGenreNameEnumValues.map[json["music_genre_name"]]!,
        musicGenreNameExtended:
            musicGenreNameEnumValues.map[json["music_genre_name_extended"]]!,
        musicGenreVanity:
            musicGenreNameEnumValues.map[json["music_genre_vanity"]]!,
      );

  Map<String, dynamic> toJson() => {
        "music_genre_id": musicGenreId,
        "music_genre_parent_id": musicGenreParentId,
        "music_genre_name": musicGenreNameEnumValues.reverse[musicGenreName],
        "music_genre_name_extended":
            musicGenreNameEnumValues.reverse[musicGenreNameExtended],
        "music_genre_vanity":
            musicGenreNameEnumValues.reverse[musicGenreVanity],
      };
}

enum MusicGenreNameEnum { POP, COUNTRY, ALTERNATIVE }

final musicGenreNameEnumValues = EnumValues({
  "Alternative": MusicGenreNameEnum.ALTERNATIVE,
  "Country": MusicGenreNameEnum.COUNTRY,
  "Pop": MusicGenreNameEnum.POP
});
