...
//
//     final musicLyricsModel = musicLyricsModelFromJson(jsonString);

import 'dart:convert';

MusicLyricsModel musicLyricsModelFromJson(String str) =>
    MusicLyricsModel.fromJson(json.decode(str));

String musicLyricsModelToJson(MusicLyricsModel data) =>
...
class MusicLyricsModel {
  ...
  factory MusicLyricsModel.fromJson(Map<String, dynamic> json) =>
      MusicLyricsModel(
